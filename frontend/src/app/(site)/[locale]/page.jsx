...
export default async function HomePage({ params }) {
  ...
  const contact = {
    ...
    form: {
      ...
      countrySelector: translations("contact.form.countrySelector"),
      countrySearch: translations("contact.form.countrySearch"),
      noCountryResults: translations("contact.form.noCountryResults"),
      validation: {
        required: translations("contact.form.validation.required"),
        fullNameLength: translations("contact.form.validation.fullNameLength"),
        invalidPhone: translations("contact.form.validation.invalidPhone"),
        invalidEmail: translations("contact.form.validation.invalidEmail"),
        emailTooLong: translations("contact.form.validation.emailTooLong"),
        messageTooLong: translations("contact.form.validation.messageTooLong"),
